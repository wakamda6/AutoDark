...
fun com.autodark.bean.DateTimeBean.convertToDateTimeEntity(): DatimeEntity {
    /**
     * {
     *   "date": "2024-08-10",
     *   "id": 1,
...
fun com.autodark.bean.DateTimeBean.convertToDateEntity(): DateEntity {
    /**
     * {
     *   "date": "2024-08-10",
     *   "id": 1,
...
fun com.autodark.bean.DateTimeBean.convertToTimeEntity(): TimeEntity {
    /**
     * {
     *   "date": "2024-08-10",
     *   "id": 1,
