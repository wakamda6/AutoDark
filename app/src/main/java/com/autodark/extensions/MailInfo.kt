...
import com.autodark.utils.EmailAuthenticator
 ...
 * 以文本格式发送邮件
 */
fun com.autodark.bean.MailInfo.sendTextMail() {
    // 判断是否需要身份认证
    ...
    try {
        ...
        val mailContent = "${this.content}，工具本版：${com.autodark.BuildConfig.VERSION_NAME}"
...
fun com.autodark.bean.MailInfo.sendAttachFileMail() {
    var authenticator: EmailAuthenticator? = null
