...
fun Activity.showDateTimePicker(dateTimeBean: com.autodark.bean.DateTimeBean?, callback: OnDateSelectedCallback) {
...
fun Activity.showDatePicker(dateTimeBean: com.autodark.bean.DateTimeBean, callback: OnDateSelectedCallback) {
